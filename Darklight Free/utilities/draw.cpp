...
void D::Initialize()
{
	for (int i = 0; i < 5; i++)
	{
		...
		I::Surface->SetFontGlyphSet(uMenuFont[i], "Verdana", ScaleDPI(12, i), 500, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
...
RECT D::GetTextSize(unsigned long font, const char* text) {
...
void D::TexturedPolygon(int n, std::vector<Vertex_t> vertice, Color col) 
{
	...
	I::Surface->DrawTexturedPolygon(n, vertice.data());
}
