...
public:
	void Create(CBaseEntity* pEntity)
	{
		...
		static auto oCreateAnimationState = (CreateAnimationStateFn)(MEM::FindPattern(CLIENT_DLL, _("55 8B EC 56 8B F1 B9 ? ? ? ? C7 46"))); // @xref: "ggprogressive_player_levelup"
	...
	void Update(QAngle angView)
	{
		...
		static auto oUpdateAnimationState = (UpdateAnimationStateFn)(MEM::FindPattern(CLIENT_DLL, _("55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 F3 0F 11 54 24"))); // @xref: "%s_aim"
	...
	void Reset()
	{
		...
		static auto oResetAnimationState = (ResetAnimationStateFn)(MEM::FindPattern(CLIENT_DLL, _("56 6A 01 68 ? ? ? ? 8B F1"))); // @xref: "player_spawn"
